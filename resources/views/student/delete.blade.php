        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" data-background-color="blue">
                    ...
                    <p class="category">Are you sure you want to delete this student profile?</p>
                </div>
                <div class="card-content">
                    <form method="post" action="{{ url('/students', $student->id) }}">
                        ...
                        <button type="submit" class="btn btn-primary pull-right" data-background-color="blue">Delete</button>
